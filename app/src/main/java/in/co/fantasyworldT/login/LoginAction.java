...
public class LoginAction extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("this is inside on click google sign in");
                signIn();
    ...
    void signIn()
    {
        System.out.println("this is inside  signin method");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            System.out.println("this is inside on activity result" +result);
  ...
  private void  handleSignInResult(GoogleSignInResult result)
    {
        ...
        System.out.println("this is inside handle signin method");
        if (result.isSuccess()) {
           ...
           // updateUI(true);
            ...
            //updateUI(false);
            System.out.println("this is inside handle signin not suucess condition");
            onLoginFailed();
        }
    }
